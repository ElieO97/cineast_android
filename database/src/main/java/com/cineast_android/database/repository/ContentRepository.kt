package com.cineast_android.database.repository
...
class ContentRepository(private val contentDatabase: ContentDatabase) {
    ...
    fun discoverContent(): Flowable<com.cineast_android.core.DiscoverContent> {
        val moviesFlowable = Flowable.zip(popularMovies, nowPlayingMovies, upcomingMovies, topRatedMovies,
                Function4<List<Movie>, List<Movie>, List<Movie>, List<Movie>, com.cineast_android.core.DiscoverContent>
                { popularMovies, nowPlayingMovies, upcomingMovies, topRatedMovies ->
                    com.cineast_android.core.DiscoverContent(
