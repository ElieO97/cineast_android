...
import com.cineast_android.adapter.DiscoverAdapter
import com.cineast_android.core.model.AccessToken
import com.cineast_android.core.model.Movie
import com.cineast_android.core.model.Person
import com.cineast_android.fragment.LoginWebviewFragment
import com.cineast_android.fragment.WebviewFragment
import com.cineast_android.utils.WebLink
...
class DiscoverVu(inflater: LayoutInflater,
    ...
    private val sessionPublisher: PublishSubject<String> by lazy {
        (activity as com.cineast_android.activity.MainActivity).sessionPublisher
    }
    ...
    fun updateView(discoverContent: com.cineast_android.core.DiscoverContent, isLoggedIn: Boolean) {
