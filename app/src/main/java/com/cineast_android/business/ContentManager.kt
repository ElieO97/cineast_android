package com.cineast_android.business
...
import com.cineast_android.business.api.response.*
import com.cineast_android.database.repository.ContentRepository
import com.cineast_android.core.model.*
import com.cineast_android.database.entity.MovieType
...
class ContentManager(private val tmdbContentClient: TmdbContentClient, private val contentRepository: ContentRepository) : CoroutineScope {
    ...
    private val persistClient: com.cineast_android.core.ValueStore by App.kodein.instance()
    private val timeStamp: Long
        get() {
            return persistClient.get(com.cineast_android.core.DiscoverContent.TIMESTAMP, null)?.toLong() ?: 0
        }
    ...
    fun discoverContent(): Flowable<com.cineast_android.core.DiscoverContent> {
    ...
    private fun isContentUpToDate(): Boolean {
        return com.cineast_android.core.DiscoverContent.isUpToDate(timeStamp)
    }
    ...
    private fun updateContent(oldDiscoverContent: com.cineast_android.core.DiscoverContent = com.cineast_android.core.DiscoverContent.emptyDiscoverContent()) {
    ...
    private fun setContentInsertionTimeStamp() {
        persistClient.set(com.cineast_android.core.DiscoverContent.TIMESTAMP, System.currentTimeMillis().toString())
    }
}